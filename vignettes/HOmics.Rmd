...
```{r ob_plot_mod, fig.cap = "\\label{fig:figs}SNP coefficients credible intervals", fig.height=4, fig.width=4, out.width="100%", fig.align="center"}
plot(mod)
```
...
```{r ob_SNPassoc_plot, fig.cap = "\\label{fig:figs}SNP coefficients confidence intervals", echo = FALSE}
library(ggplot2)
...
```{r ob_plot_multiv_mod, fig.cap = "\\label{fig:figs}SNP coefficients credible intervals in the multivariate model", fig.height=4, fig.width=4, out.width="100%", fig.align="center"}
plot(mod.multiv)
```
...
```{r meth_plot_res,  fig.cap = "\\label{fig:figs}CpGs coefficients credible intervals", fig.height=3, fig.width=3, out.width="100%", fig.align="center"}
...
```{r plot.ov.model,  fig.cap = "\\label{fig:figs}Gene coefficients credible intervals using HOmics"}

plot(mod.ov)

```

```{r limma_plot, fig.cap = "\\label{fig:figs}Gene coefficients credible intervals using limma", echo = FALSE}
library(ggplot2)
