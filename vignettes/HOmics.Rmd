...
```{r obSNPassocPlot, fig.cap = "SNP coefficients confidence intervals. Confidence intervals for the assessed SNPs obtained with SNPassoc.", echo = FALSE}
library(ggplot2)
...
```{r aggmatrix, fig.cap = "aggregation matrix", out.width = "60%", echo = FALSE}
...
```{r methPlotRes,  fig.cap = "CpGs coefficients credible intervals. Credible intervals for the assessed CpGs obtained with HOmics.", fig.height=3, fig.width=3, out.width="100%", fig.align="center"}
...
```{r plotOvModel,  fig.cap = "Gene coefficients credible intervals using HOmics. Credible intervals for the assessed genes obtained with HOmics."}

plot(mod.ov)

```

```{r limmaPlot, fig.cap = "Gene coefficients credible intervals using limma.  Confidence intervals for the assessed genes obtained with limma.", echo = FALSE}
library(ggplot2)
