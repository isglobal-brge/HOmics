...
```{r fig1, fig.cap = "Hierarchical model. Levels and components of the HOmics hierarchical model.", fig.height=4, fig.width=4, out.width="100%", echo = FALSE}
...
```{r obPlotMod, fig.cap = "SNP coefficients credible intervals. Credible intervals for the assessed SNPs obtained with HOmics.", fig.height=4, fig.width=4, out.width="100%", fig.align="center"}
plot(mod)
```
...
```{r obSNPassocPlot, fig.cap = "SNP coefficients confidence intervals. Confidence intervals for the assessed SNPs obtained with SNPassoc.", fig.height=4, fig.width=4, out.width="100%", echo = FALSE}
library(ggplot2)
...
```{r aggmatrix, fig.cap = "aggregation matrix. aggregation.matrix, where gi represent the groups and fi the features. Black grey indicates feature fi belonging to gi group (1 in the matrix) and pale grey non belonging (0 in the matrix).", out.width = "60%", echo = FALSE}
...
The results are again provided as an \textit{HOmics} object, and results show this time the coefficients for the multivariate model
...
```{r obPlotMultivMod, fig.cap = "SNP coefficients credible intervals in the multivariate model. Credible intervals for the assessed SNPs obtained with HOmics in the multivariate model.", fig.height=4, fig.width=4, out.width="100%", fig.align="center"}
plot(mod.multiv)
```
...
GSE117929 contains a methylome-wide analysis of 37 samples of peripheral blood mononuclear cells of systemic sclerosis (SSc, N=18) and normal controls (NC, N=19).
...
```{r methPlotRes,  fig.cap = "CpGs coefficients credible intervals. Credible intervals for the assessed CpGs obtained with HOmics.", fig.height=3, fig.width=3, out.width="80%", fig.align="center"}
...
# Ovarian cancer gene expression with targeted miRNAs
...
```{r plotOvModel,  fig.cap = "Gene coefficients credible intervals using HOmics. Credible intervals for the assessed genes obtained with HOmics.",fig.height=4, fig.width=4, out.width="100%"}

plot(mod.ov)

```

```{r limmaPlot, fig.cap = "Gene coefficients credible intervals using limma. Confidence intervals for the assessed genes obtained with limma.",fig.height=4, fig.width=4, out.width="100%",  echo = FALSE}
library(ggplot2)
